...
public class MicroBlog2
{
    ...
    public static void main(String[]args)
    {
        ...
        ArrayList<Content2>createdPosts=new ArrayList<Content2>();
        ...
        do {
            ...
            if (option == 1) {
                ...
                allUsers.add(new User2(name,screenName, url,emailAdd));
            ...
            if (option == 2) {
                ...
                if(currentUser.equals(""))
                {
                    ...
                    createdPosts.add(new Content2(newPost, currentUser));
                }
                if (option == 4)
                {
